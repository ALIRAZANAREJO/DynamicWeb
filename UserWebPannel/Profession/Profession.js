...
function setupProfessionMultiSelect(inputId, items) {
  const input = document.getElementById(inputId);

  // Hide real input (for DB storage)
  ...
  // Update hidden input for Firebase
  ...
  function renderDropdown() {
    ...
    filteredItems.forEach((item, index) => {
      ...
      if (index === highlightedIndex) option.classList.add("highlighted");
...
setupProfessionMultiSelect("professionInput", [
