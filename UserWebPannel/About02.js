...
// // ===================== RECALL PROFESSION + HOBBIES + LANGUAGES =====================

// // ---- Professionality (only profession tags if you still use profInst) ----
// if (data.Professionality && data.Professionality.profession) {
//   const profValue = data.Professionality.profession;
//   profInst.setSelectedFromString(profValue || "");
// } else {
//   profInst.clear();
// }

// // ---- Personal (Qual, Paddres, Optional) ----
// if (data.Personal) {
...
//   // Optional
//   optInst.setSelectedFromString(p.Optional || "");
// } else {
//   qualInst.clear();
//   paddresInst.clear();
//   optInst.clear();
